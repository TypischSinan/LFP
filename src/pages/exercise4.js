...
const questions = require("../questions/pythonExercise4.json");
...
const Home = ({ isDarkMode }) => {
  ...
  useEffect(() => {
    ...
    const currentScore = localStorage.getItem("pythonQuiz4");
    if (!currentScore || score > currentScore) {
      localStorage.setItem("pythonQuiz4", score);
    }
  }, [score]);
          ...
          <div className="flex flex-col items-center">
            {shuffledAnswers.map((answer, index) => (
              <button
                ...
                } p-3 rounded w-full mb-4 transition duration-300 ease-in-out transform hover:scale-100`}
